...
import { getVenueOrderSettings,updateVenueOrderSettings,createOrder,getOrderDetails,getLiveOrders,getClosedOrders,deleteOrder,updateOrderStatus,updateOrderSummaryItem } from "../controllers/order.controller.js";
...
// update order settings
orderRouter.put("/ordersummary/:orderId", authenticateToken,updateOrderSummaryItem);
